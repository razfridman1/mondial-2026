...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: "לכל משחק תוכל לנחש תוצאה. פגיעה + תוצאה מדויקת = 7 נקודות, פגיעה בלבד = 3, פגיעה + הפרש שערים נכון = +1 (בתיקו אין בונוס הפרש).",
    highlight: "🔥 סטריקים — כל ניחוש נכון ברצף שווה נקודת בונוס נוספת",
  },
  {
    emoji: "⏰",
