...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: "לכל משחק תוכל לנחש תוצאה. מדויק = 7 נקודות, רק התוצאה הנכונה = 3, הפרש שערים נכון = +1.",
    highlight: "🃏 הג׳וקר ×2 — הקפיץ את הניקוד למשחק קריטי",
  },
  {
    emoji: "⏰",
    ...
    highlight: "תזכורות במייל ובדפדפן: שעה / 15 דק׳ / סגירת הימורים",
  },
  {
    emoji: "👥",
