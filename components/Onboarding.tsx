...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: "בשלב הבתים: פגיעה + תוצאה = 7 נק׳, פגיעה = 3, +1 על הפרש שערים נכון (לא בתיקו). בנוקאאוט: בוחרים מנצחת + ניקוד 90 דק׳. מנצחת + תוצאה = 8 נק׳, מנצחת + הפרש = 5, מנצחת לבד = 3. תיקו ב-90 דק׳ → הארכה (30 דק׳) → פנדלים אם צריך.",
